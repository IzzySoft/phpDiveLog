...
<table class="outer" border="1" cellpadding="2" align="center" style="margin-top:7">
 <tr><td>{nav_left}</td><th>{nick_name}</th><th>{name_name}</th>
     <th>{loc_name}</th><th>{status_name}</th><td align="right">{nav_right}</td></tr>

<!-- BEGIN itemblock -->
 <tr><th align="right"><a href="{buddy_ref}">{buddy#}</a></th>
