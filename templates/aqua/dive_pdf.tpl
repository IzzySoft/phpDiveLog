...
<!-- BEGIN topleftblock -->
     <TD WIDTH="32" STYLE="font-size:10;">&nbsp;</TD>
     <TD WIDTH="264" STYLE="font-size:10;"><DIV ALIGN="center"><B>{location} / {place}</B></DIV></TD>
     <TD WIDTH="32" STYLE="font-size:10;" ALIGN="right"><B>#{dive#}</B>&nbsp;</TD>
<!-- END topleftblock -->
<!-- BEGIN toprightblock -->
     <TD WIDTH="32" STYLE="font-size:10;">&nbsp;<B>#{dive#}</B></TD>
     <TD WIDTH="264" STYLE="font-size:10;"><DIV ALIGN="center"><B>{location} / {place}</B></DIV></TD>
     <TD WIDTH="32" STYLE="font-size:12;">&nbsp;</TD>
<!-- END toprightblock -->
