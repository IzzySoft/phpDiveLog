...
<!-- BEGIN topleftblock -->
     <TD WIDTH="60" STYLE="font-size:12px;" ALIGN="right">&nbsp;</TD>
     <TD WIDTH="208" STYLE="font-size:10px;"><DIV ALIGN="center"><B>{stats_name}</B></DIV></TD>
     <TD WIDTH="60" STYLE="font-size:8px;" ALIGN="right"><B>{date}</B>&nbsp;</TD>
<!-- END topleftblock -->
<!-- BEGIN toprightblock -->
     <TD WIDTH="40" STYLE="font-size:10px;">&nbsp;<B>#{date}</B></TD>
     <TD WIDTH="280" STYLE="font-size:10px;"><DIV ALIGN="center"><B>{stats_name}</B></DIV></TD>
     <TD WIDTH="40" STYLE="font-size:12px;" ALIGN="right">&nbsp;</TD>
<!-- END toprightblock -->
...
<!-- END sumblock -->
   <TR STYLE="font-size:15px;"><TD></TD></TR><!-- Spacer for TCPDF -->
...
<!-- END lgraphblock -->
   </DIV></TD></TR></TABLE></TD><TD WIDTH="162"><DIV ALIGN="center"><!-- Right side: Graphs -->
<!-- BEGIN rgraphblock -->
      <B>{graph_name}</B><BR /><IMG SRC="{graph_src}" WIDTH="{graph_width}" HEIGHT="{graph_height}" ALT="{graph_alt}" />&nbsp;
<!-- END rgraphblock -->
   </DIV></TD>
